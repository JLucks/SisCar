 ...
 * @author Jorge
 */
public class RemoverFuncionario extends javax.swing.JPanel {
    ...
    private void bttRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttRemoverActionPerformed
        if(jcbId.getSelectedIndex() != 0){
            if(JOptionPane.showConfirmDialog(null, "Deseja mesmo remover?")==JOptionPane.YES_OPTION){
                ...
                daoA.deletaAdministradorFunc(this.fun.getCodFunc());
                daoG.deletaGerenteFunc(this.fun.getCodFunc());
                daoV.deletaVendedorFunc(this.fun.getCodFunc());
                dao.deletaFuncionario(this.fun.getCodFunc());
    ...
    private void jcbIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jcbIdFocusLost
        this.fun = dao.buscaFuncionario(jcbId.getSelectedItem().toString());
        jtfNome.setText(this.fun.getNome());
    ...
    private void loadDados(){
        ...
        for(Funcionario fun: list){
            this.dados[i] = String.valueOf(fun.getCpf());
            i++;
        }
    }
