...
public class CadastroGerente extends javax.swing.JPanel {
    ...
    private static DAOgerente dao = new DAOgerente();;
    ...
    private void loadFuncs(){
        ...
        removeGer(list);
        CadastroAdministrador.removeAdms(list);
        CadastroVendedor.removeVen(list);
    ...
    public static void removeGer(List<Funcionario> list){
        List<Gerente> gers = dao.recuperaGerentes();
        List<Funcionario> f = new ArrayList<>();
        if(!gers.isEmpty()&&!list.isEmpty()){
            Collections.sort(gers);
            for(Funcionario func: list){
                for(Gerente geres: gers){
                    if(func.getCodFunc()==geres.getCodFun()){
                        f.add(func);
                        gers.remove(geres);
                        break;
                    }
