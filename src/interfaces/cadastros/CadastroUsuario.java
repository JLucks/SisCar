...
public class CadastroUsuario extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jcbFuncionario.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        bttAddFunc.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void bttSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttSalvarActionPerformed
        if(checarCampos()){
            if(String.valueOf(jpfSenha.getPassword()).equals(String.valueOf(jpfNsenha.getPassword()))){
                ...
                usu.setSenha(Encrypt.encrypt(usu.getIdUsuario(), String.valueOf(jpfSenha.getPassword())));
    ...
    public static void removeUsu(List<Funcionario> list){
        List<Usuario> usus = dao.recuperaUsuarios();
        List<Funcionario> f = new ArrayList<>();
        if(!usus.isEmpty()&&!list.isEmpty()){
            Collections.sort(usus);
            for(Funcionario func: list){
                for(Usuario usu: usus){
                    if(func.getCodFunc()==usu.getCodFun()){
                        f.add(func);
                        usus.remove(usu);
                        break;
                    }
