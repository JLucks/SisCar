...
public class CadastroAdministrador extends javax.swing.JPanel {
    ...
    private static DAOadministrador dao = new DAOadministrador();
    ...
    private void bttSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttSalvarActionPerformed
        if(checarCampos()){
            ...
            this.dao.adicionaAdministrador(adm);
    ...
    public static void removeAdms(List<Funcionario> list){
        List<Administrador> adms = dao.recuperaAdministradores();
        List<Funcionario> f = new ArrayList<>();
        if(!adms.isEmpty()&&!list.isEmpty()){
            Collections.sort(adms);
            for(Funcionario func: list){
                for(Administrador adm: adms){
                    if(func.getCodFunc()==adm.getCodFunc()){
                        f.add(func);
                        adms.remove(adm);
                        break;
                    }
