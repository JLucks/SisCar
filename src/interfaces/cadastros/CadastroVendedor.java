...
public class CadastroVendedor extends javax.swing.JPanel {
    ...
    private static DAOvendedor dao = new DAOvendedor();
    ...
    private void loadFuncs(){
        ...
        CadastroGerente.removeGer(list);
    ...
    public static void removeVen(List<Funcionario> list){
        List<Vendedor> vens = dao.recuperaVendedores();
        List<Funcionario> f = new ArrayList<>();
        if(!vens.isEmpty()&&!list.isEmpty()){
            Collections.sort(vens);
            for(Funcionario func: list){
                for(Vendedor vends: vens){
                    if(func.getCodFunc()==vends.getCodFunc()){
                        f.add(func);
                        vens.remove(vends);
                        break;
                    }
