...
public class CadAluguel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bttCalcular.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        bttAdicionarCliente.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
    ...
    private void bttAdicionarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttAdicionarClienteActionPerformed
        ...
        Main.janela.add(new CadastroCliente(2,this.vendedor));
    ...
    private void bttCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttCalcularActionPerformed
        if(checarCampos()){
            ...
            jtaResultado.setText(jtaResultado.getText()+"Veiculo: "+jcbVeiculo.getSelectedItem().toString()+"\n");
    ...
    private void bttConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttConfirmarActionPerformed
        if(checarCampos()){
            ...
            aluguel.setTotal(0);
            aluguel.setDataAlu(dateAlu());
            aluguel.setDataDev(dateDev());
            dao.adicionaAluguel(aluguel);
    ...
    public static void removeCli(List<Cliente> list){
        List<Aluguel> alu = new DAOaluguel().recuperaAlugueisAbertos();
        List<Cliente> c = new ArrayList<>();
        if(!alu.isEmpty()&&!list.isEmpty()){
            for(Cliente cli: list){
                for(Aluguel al: alu){
                    if(cli.getCodCli()==al.getCodCli()){
                        c.add(cli);
                        alu.remove(al);
                        break;
                    }
    ...
    public static void removeVei(List<Veiculo> list){
        List<Aluguel> alu = new DAOaluguel().recuperaAlugueisAbertos();
        List<Veiculo> v = new ArrayList<>();
        if(!alu.isEmpty()&&!list.isEmpty()){
            for(Veiculo vei: list){
                for(Aluguel al: alu){
                    if(vei.getCodVei()==al.getCodVei()){
                        v.add(vei);
                        alu.remove(al);
                        break;
                    }
